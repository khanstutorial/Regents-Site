...
def makeFile(nbrhood):
    ...
    titleString = "id=\"Neighborhood Title\">Regents - Khan's Tutorial</title>"
    bannerString = "id=\"Neighborhood 1\">Regents Tutoring</h1>"
    featureString = "Why do families choose Khan's"
    newTString = titleString.replace("Regents - Khan's Tutorial</title>",nbrhood.replace('-',' ')+" Regents - Khan's Tutorial</title>")
    newBString = bannerString.replace("Regents Tutoring</h1>",nbrhood.replace('-',' ')+" Regents Tutoring</h1>")
